    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_link', models.CharField(blank=True, max_length=20, null=True, verbose_name='Telegram link')),
                ('twitter_link', models.CharField(blank=True, max_length=20, null=True, verbose_name='Twitter link')),
                ('instagram_link', models.CharField(blank=True, max_length=20, null=True, verbose_name='Instagram link')),
                ('whatsapp_link', models.CharField(blank=True, max_length=20, null=True, verbose_name='Whatsapp link')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='shop.customer', verbose_name='Customer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='values', to='shop.featurekey', verbose_name='Key')),
            ],
            options={
                'verbose_name': 'Feature Value',
                'verbose_name_plural': 'Feature Value',
            },
            bases=(parler.models.TranslatableModelMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secondhand', models.BooleanField(default=False, verbose_name='Seccond Hand')),
                ('badge', models.CharField(blank=True, max_length=255, null=True, verbose_name='Badge')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Deleted at')),
                ('key', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='shop.featurekey', verbose_name='Key')),
                ('value', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='shop.featurevalue', verbose_name='Value')),
        ...
        migrations.CreateModel(
            name='FeatureKeyTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('key', models.CharField(max_length=50, verbose_name='Key')),
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='shop.featurekey')),
            ],
            options={
                'verbose_name': 'Feature Key Translation',
                'db_table': 'shop_featurekey_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
                'unique_together': {('language_code', 'master')},
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Feature Value Translation',
